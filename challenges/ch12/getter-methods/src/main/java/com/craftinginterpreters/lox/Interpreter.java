...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
  ...
  public Object visitGetExpr(Expr.Get expr) {
    ...
    if (object instanceof LoxInstance klass) {
      var value = klass.get(expr.name);
      if (value instanceof LoxFunction f && f.isGetter) {
        return f.call(this, List.of());
      }
      return value;
    }
  ...
  public Void visitClassStmt(Stmt.Class stmt) {
    ...
    for (var getter : stmt.getters) {
      LoxFunction function = new LoxFunction(new Stmt.Function(getter.name, List.of(), getter.body),
