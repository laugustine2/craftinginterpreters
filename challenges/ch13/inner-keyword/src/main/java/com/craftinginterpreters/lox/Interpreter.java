...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
  ...
  public Object visitInnerExpr(Expr.Inner expr) {
    ...
    var innerMethod = environment.getAt(distance, "inner");
    if (!(innerMethod instanceof LoxCallable)) {
      throw new RuntimeError(expr.keyword, "'inner' method is not defined.");
    }
    LoxCallable function = (LoxCallable) innerMethod;
